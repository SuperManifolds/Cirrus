    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            DetailCardsGrid(cards: [
                ...
                OzoneCard(airQuality: airQuality),
                NitrogenDioxideCard(airQuality: airQuality),
                SulphurDioxideCard(airQuality: airQuality),
                CarbonMonoxideCard(airQuality: airQuality),
